...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'created', 'updated', 'get_total_cost', 'sender_name', 'manager_confirmed', 'assigned_waiter')
    list_filter = ('created', 'updated', 'payment_method', 'manager_confirmed', 'assigned_waiter')
    search_fields = ('user__username', 'sender_name', 'assigned_waiter__name')
    readonly_fields = ('created', 'updated')
    fields = ('user', 'created', 'updated', 'payment_method', 'sender_name', 'manager_confirmed', 'assigned_waiter', 'get_total_cost')
    form = OrderForm
